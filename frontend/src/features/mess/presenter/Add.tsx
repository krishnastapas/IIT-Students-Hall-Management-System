...
import { addMess } from '../repository';
...
function Add(props: {
    ...
    const handleHallhange = (studyOption: any, ActionMeta: any) => {
        ...
        const arr = findSectionIdAndsetArray(selectedValues)
        setSelectedHall(arr);
    };

    const findSectionIdAndsetArray = (arr: string[]) => {
                        ...
                        <form className="space-y-6" action="#">
                            ...
                            <div>
                                ...
                                <input
                                    value={mess.password}
                                    onChange={(e: any) => {
                                        setMess({ ...mess, password: e.target.value })
                                    }}
                                    type="password" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                    required />
                            </div>
                            ...
                            <div>
                                <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cose Of per Day Meal (in Rs)*</label>
                                <input
                            ...
                            <div>
                                <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Established by *</label>
                                <input
                            ...
                            <div className="md:col-span-5">
                                <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Date Of establishment *</label>
