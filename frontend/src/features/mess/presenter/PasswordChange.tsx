...
import { MessInterface } from '../Model';
...
function PasswordSet(props: {
    ...
    const [mess, setMess] = useState<MessInterface>(props.mess)

    const handleSubmitButton = async (e: any) => {
        e.preventDefault()
        console.log(mess)
        const data = await passwordSetApi(mess);
        if (data) {
            props.onClose()
        }
            ...
            <div className="relative w-full max-w-md max-h-full mx-auto">
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="px-6 py-6 lg:px-8">
                        ...
                        <h3 className="mb-4 text-xl font-medium text-gray-900 dark:text-white">{mess.name}:{mess.email}</h3>
                        <form className="space-y-6" action="#">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="mess name" required />
                            </div>
