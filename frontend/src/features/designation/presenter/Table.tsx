                        ...
                        {props.hallList.map((hall: HallInterface, index: number) => {
                            return (
                                <tr className="border-b dark:border-gray-700">
                                    ...
                                    <td className="px-2 py-3">{hall.dob}</td>
                                    <td className="px-2 py-3">{hall.date_of_joining}</td>
                                    <td className="px-2 py-3">{hall.designation}</td>
                                    <td className="px-2 py-3">{hall.salary}</td>
                                    <td className="px-2 py-3">{hall.salaryType}</td> */}
                                    ...
                                    <td className="px-2 py-3">
                                        ...
                                        {/* <Switch checked={hall.active}
                                            handleChange={(value)=>{
                                                // props.handleActiveButton(value,hall)
                                                console.log(value)
                                                handleActiveButton(hall,value)
                                            }} /> */}
                                        {/* <label className="relative inline-flex items-center cursor-pointer">
                                            ...
                                            checked={hall.active}
                                            onChange={()=>{
                                                handleActiveButton(hall,!hall.active)
                                            }}
