...
import { addBlock, editBlock } from '../repository';
...
function Edit(props: {
    ...
    const handleSubmitButton = async (e: any) => {
        ...
        const data = await editBlock(block);
        if (data) {
            props.getBlockList();
            props.onClose()
        }
            ...
            <div className="relative w-full max-w-md max-h-full mx-auto">
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="px-6 py-6 lg:px-8">
                        <h3 className="mb-4 text-xl font-medium text-gray-900 dark:text-white">Edit block</h3>
                        <form className="space-y-6" action="#">
                            ...
                            <button
                                ...
                                className="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Edit block</button>
